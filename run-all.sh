...
run_service "Login"              8081 "Login"
run_service "RegistroUsuario"    8082 "RegistroUsuario"
run_service "Inventario"         8083 "ms-Inventario"
...
echo "  Login .......... http://localhost:8081/swagger-ui.html"
  echo "  Registro ....... http://localhost:8082/swagger-ui.html"
  echo "  Inventario ..... http://localhost:8083/swagger-ui.html"
